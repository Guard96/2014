...
void ToUnit(char *str1,char *str2,int LenStr,int m)
{
	int n,i;
	n=LenStr+m;
	for(i=0;i<n;i++)
...
void StrCopy(char *str1,char *str2,int m,int n)
{
	for(int i=m;i<n;i++)
	{	*(str2+i-m)=*(str1+i);
		*(str2+n-m)='\0';
...
WORD OnClientConnect(HWND hwnd,char *Addr)
{
