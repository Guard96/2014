...
const int M1 = 4;
const int M2 = 5;
int c1[N1]; //счётчик отрицательных элементов столбцов
int c2[N2];
...
//находим количество отрицательных элеметов в каждой строке
if(opt1)
{
...
if(m1[i][j] < 0)
c1[i]++;
cout « "Количество отрицательных элементов в "« i « "-й строке: " « c1[i] « endl;
}
}
if(opt2)
{
