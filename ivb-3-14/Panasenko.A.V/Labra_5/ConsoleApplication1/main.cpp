...
int main(int argc, char **argv)
{
	...
	if (c1 > c2) {
		printf("В первой матрице среднее арифметическое положительных элементов равно .\n", CountPositiveElement(m1));
		printf("В первой матрице %i отрицательных элементов .\n", CountNegativeElement(m1));
	}
	else {
		printf("Во второй матрице среднее арифметическое положительных элементов равно .\n", CountPositiveElement(m2));
